...
int main(int argc, char **argv)
{
	...
	text = text_layout_create(200, 30);
	text_layout_set_font(text, "Liberation Sans", 24);


	for(i=0;i<FRAME_PER_SECOND*60;i++)
	{
		...
		text_layout_copy_to_yuv420p(text, 460, 300, buffer, CAPTURE_WIDTH, CAPTURE_HEIGHT);
